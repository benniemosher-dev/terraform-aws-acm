...
![CI Terraform](https://github.com/benniemosher-dev/terraform-aws-acm/actions/workflows/ci-terraform.yml/badge.svg)

🔖 A TF module for AWS ACM Certificates. 🔖
...
| <a name="output_domain-validation-options"></a> [domain-validation-options](#output\_domain-validation-options) | The options for creating a DNS record. |
<!-- END_TF_DOCS -->
